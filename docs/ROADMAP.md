...
- Scope-Entscheidung (vermerkt 2026-07-15, siehe GDD 5): bewusst **Tiefe statt Breite** — wenige Dinge bekommen Kunst, aber Animationssystem und Dual-Grid sollen strukturell schon so funktionieren wie in der finalen Version, nicht als Wegwerf-Lösung für später nochmal umgebaut werden.
